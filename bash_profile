...
#   ------------------------------------------------------------
    ...
    export PATH=$CATALINA_BASE:$PATH
    export PATH=$MONGO_PATH/bin:$PATH
    export PATH="/usr/local/git/bin:/sw/bin/:/usr/local/bin:/usr/local/:/usr/local/sbin:$MYSQL_PATH/bin:$PATH"
...
alias eclipse='/Users/masud/eclipse/jee-neon/Eclipse.app/Contents/MacOS/eclipse -clean' #start eclipse
